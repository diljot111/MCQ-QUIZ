...
function Categories() {
  ...
  const router = createBrowserRouter([
    ...
    { path: "/ai", element: <AiQuiz /> },
    { path: "/mcq2", element: <Category2 /> },
    { path: "/mcq3", element: <Category3 /> },
    { path: "/mcq4", element: <h1 className="text-center text-2xl mt-10">Welcome to Category 4!</h1> },
    { path: "/mcq5", element: <h1 className="text-center text-2xl mt-10">Welcome to Category 5!</h1> },
    { path: "/mcq6", element: <h1 className="text-center text-2xl mt-10">Welcome to Category 6!</h1> },
  ]);
